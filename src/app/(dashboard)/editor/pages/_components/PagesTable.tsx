      ...
      <AlertDialog open={!!deletePageId} onOpenChange={open => !open && setDeletePageId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action cannot be undone. The page and all its related data will be permanently deleted.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel onClick={() => setDeletePageId(null)}>Cancel</AlertDialogCancel>
