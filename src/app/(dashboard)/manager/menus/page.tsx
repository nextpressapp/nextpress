...
export default function MenuManagerPage() {
    ...
    const canManageMenus = session?.user.role === 'ADMIN' || session?.user.role === 'MANAGER'
        ...
        <div>
            ...
            <Card>
                <CardHeader className='items-center justify-center'>
                    <CardTitle className='font-bold text-2xl'>Menu Management</CardTitle>
                </CardHeader>
                <CardContent className='items-center justify-center'>
                    <div className='space-y-10'>
                            ...
                            <div className='flex flex-row items-center justify-center px-8'>
                                <Select value={selectedMenu?.id || ''} onValueChange={handleMenuSelect}>
                                    ...
                                    <SelectContent className='px-8'>
                                        {menus.map((menu) => (
                                            <SelectItem key={menu.id} value={menu.id} className='px-8'>
                                                {menu.name}
                                            </SelectItem>
                                        ))}
                                    </SelectContent>
                                ...
                                { selectedMenu && (
                                    <AlertDialog>
                                        <AlertDialogTrigger asChild>
                                            <Button variant='destructive' className='px-8'>Delete Menu</Button>
                                        </AlertDialogTrigger>
                                        <AlertDialogContent>
                                            <AlertDialogHeader>
                        ...
                        {selectedMenu && (
                            <div
                                className='flex flex-row items-center justify-center mt-8 space-y-2 font-bold text-2xl'>
                        ...
                        {canManageMenus && (
                            <>
                                ...
                                <div className='flex flex-col items-center justify-center mt-8 space-y-2'>
                                    <Label htmlFor="new-menu-name" className='font-bold text-2xl'>New Menu Name</Label>
                                    <Input
                                        id="new-menu-name"
                                        value={newMenuName}
