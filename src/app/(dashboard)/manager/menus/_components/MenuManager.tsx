...
export default function MenuManager({ isAdmin }: MenuManagerProps) {
    ...
    const handleAddItem = async () => {
        if (!selectedMenu || !newItemLabel || !newItemUrl || !canManageMenus)
            return;
            ...
            const response = await fetch(
                `/api/menus/${selectedMenu.id}/items`,
                {
                    ...
                    body: JSON.stringify({
                        ...
                        url: newItemUrl,
                        parentId:
                            newItemParent === "none" ? null : newItemParent,
                    }),
                }
            );
    ...
    const handleDragEnd = async (result: DropResult) => {
        ...
        try {
            const response = await fetch(
                `/api/menus/${selectedMenu.id}/reorder`,
                {
                    method: "PUT",
                    headers: { "Content-Type": "application/json" },
        ...
        <div className="space-y-6">
                            ...
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                        ...
                                        permanently delete the menu and all its
                                        items.
                                    </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
            ...
            {canManageMenus && (
                <>
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="new-item-parent">
                            Parent Item (optional)
                        </Label>
                        <Select
                            value={newItemParent}
                            onValueChange={setNewItemParent}
                        >
                            <SelectTrigger>
                ...
                >
                    <AlertDialogContent>
                        ...
                        <AlertDialogFooter>
                            ...
                            <AlertDialogAction onClick={handleUpdateItem}>
                                Update
                            </AlertDialogAction>
                        </AlertDialogFooter>
                    </AlertDialogContent>
