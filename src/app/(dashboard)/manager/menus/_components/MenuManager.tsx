    ...
    try {
      ...
      if (response.ok) {
        setSelectedMenu(prevMenu => {
          ...
          return {
            ...prevMenu,
            items: Array.isArray(prevMenu.items) ? prevMenu.items.filter(item => item.id !== itemId) : [],
          };
        });
    ...
    <div className="space-y-6">
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                ...
                <AlertDialogFooter>
                  ...
                  <AlertDialogAction onClick={() => handleDeleteMenu(selectedMenu.id)}>Delete</AlertDialogAction>
                </AlertDialogFooter>
              </AlertDialogContent>
            </AlertDialog>
          )}
      ...
      {canManageMenus && (
        <>
          <div className="space-y-2">
            ...
            <Input id="new-item-label" value={newItemLabel} onChange={e => setNewItemLabel(e.target.value)} />
          </div>
          <div className="space-y-2">
            <Label htmlFor="new-item-url">New Item URL</Label>
            <Input id="new-item-url" value={newItemUrl} onChange={e => setNewItemUrl(e.target.value)} />
          </div>
          <div className="space-y-2">
      ...
      {isAdmin && (
        <div className="mt-8 space-y-2">
          ...
          <Input id="new-menu-name" value={newMenuName} onChange={e => setNewMenuName(e.target.value)} />
