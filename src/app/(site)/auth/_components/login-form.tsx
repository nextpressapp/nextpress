      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="mt-2 text-center">
            <Button variant="outline" onClick={requestVerificationEmail} disabled={isRequestingVerification}>
              {isRequestingVerification ? "Sending..." : "Resend verification email"}
            </Button>
          </div>
        </CardContent>
        <CardFooter>
          <p className="text-sm text-center w-full text-muted-foreground">Don&#39;t have an account? </p>
