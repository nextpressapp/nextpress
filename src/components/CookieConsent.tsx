        ...
        <Card className="fixed bottom-4 left-4 right-4 max-w-lg mx-auto z-50">
            ...
            <CardContent>
                <p className="text-sm text-muted-foreground">
                    By clicking &quot;Accept&quot;, you agree to the use of cookies on this website. You can change your settings at any time by visiting our <Link href="/privacy-policy">Privacy Policy</Link>.
                </p>
            </CardContent>
