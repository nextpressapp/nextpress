        ...
        body={
            <>
                <Text style={paragraphStyle}>
                    We&#39;re excited to have you on board. NextPress is a powerful content management system built with Next.js, offering you the flexibility and performance you need for your web projects.
                </Text>
                <Text style={paragraphStyle}>
